...
This repository contains my AoC solutions for 2025. Don't know what Advent of Code is? Read more on [their website](https://adventofcode.com/).
...
If you want to use something like this repository for your own solutions, you can use [my template](https://github.com/Scyak/aoc-template).

If you just want to look at or run my solutions, simply clone this repository.
